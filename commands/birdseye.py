...
CHANGELOG:
        2011.02.13 - Built into todo-py (codemac)
...
__version__ = "1.2"
__date__ = "2006/05/02"
__updated__ = "2011/02/13"
__author__ = "Gina Trapani (ginatrapani@gmail.com)"
__copyright__ = "Copyright 2006, Gina Trapani"
__license__ = "GPL"
__history__ = """
1.2 - Updated to be a plugin for todo-py
1.0 - Released.
"""

def register(COMMANDS, subparser):
	parser_cmd_add = subparser.add_parser('birdseye',
					    #  aliases=('bird', 'b'), #enable in 3.2
					      help='Birdseye view of everything')
	COMMANDS['birdseye'] = main
...
def main(args):
	...
	try:
		...
		print "ERROR:  The file named %s could not be read."% (args.todofile, )
		usage()
		sys.exit(2)
	...
	try:
		...
		print "ERROR:  The file named %s could not be read."% (args.donefile, )
		usage()
		sys.exit(2)
